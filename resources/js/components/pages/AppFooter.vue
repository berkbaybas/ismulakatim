<template>
    <footer>
        ...
        <div class="wrapperFooter">
            <h3 class="text-center mb-4">ismulakatim.com</h3>
            <div class="container">
                <div class="row">
                    <div class="col-md-4">
                    ...
                    <div class="col-md-4">
                        <div class="wrapperFooterBox">
                            <h4>En çok Aranan Şirketler</h4>
                            <p>Renault Mülakatları</p>
                            <p>Bosch Mülakatları</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="wrapperFooterBox">
                            <h4>En çok Aranan İşler</h4>
                            <p>Bigisayar Mühendisliği</p>
                            <p>Lojistik Mühendisliği</p>
                        </div>
                    </div>
                </div>
            </div>
